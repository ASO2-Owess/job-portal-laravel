...
<div class="row g-4 mb-5">
    ...
    <div class="col-md-4 d-flex align-items-stretch">
        <a href="{{ route('candidate.projects.create') }}" class="btn btn-candidate w-100 d-flex align-items-center justify-content-center">
            + Ajouter un projet
        </a>
    </div>
</div>
    ...
    @forelse ($applications as $application)
        <div class="col-12">
            <div class="card-surface p-3 d-flex flex-row justify-content-between align-items-center">
                ...
                <a href="{{ route('jobs.show', $application->jobPost) }}" class="btn btn-outline-light btn-sm">Voir l'offre</a>
            </div>
        </div>
    @empty
